...
""" MODIFIED """
cuda_eventset = CypapiCreateEventset()
""" MODIFIED """
...
""" MODIFIED """
cuda_ntv_evt3 = cyPAPI_event_name_to_code("cuda:::smsp__sass_thread_inst_executed_op_ffma_pred_on.sum:device=0");
""" MODIFIED """
...
#cuda_ntv_evt10 = cyPAPI_event_name_to_code("cuda_7011:::smsp__ops_path_tensor_src_bf16_dst_fp32.sum:device=0");
...
""" MODIFIED """
cuda_eventset.start()
print("Starting single precision\n")
""" MODIFIED """
start_timer()
...
""" MODIFIED """
current_cntr_vals = cuda_eventset.read()
print(f'Values currently held in cuda_eventset: {current_cntr_vals}')
# reset counters # MODIFIED
try:
    cuda_eventset.reset()
except Exception:
    print('Counters have not successfully been reset.')
else:
    reset_cntr_vals = cuda_eventset.read()
    print(f'Counters have been successfully reset: {reset_cntr_vals}')
""" MODIFIED """
cuda_eventset.start()
start_timer()
for epoch in range(epochs):
...
#print( f"Hardware Counts for hmul:", hw_counts[7])
#print( f"Hardware Counts for hfma:", hw_counts[8])
#print( f"Hardware Counts for hfma:", hw_counts[9])
#print( f"Hardware Counts for src_bf16_dst_fp32:", hw_counts[0])
print( f"Hardware Counts for ffma:", hw_counts[0])
print( f"Hardware Counts, {hw_counts}")
